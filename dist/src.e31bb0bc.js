...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/jquery/dist/import-jquery.js":[function(require,module,exports) {
"use strict";
...
// This file starts jquery without any troubles
var _default = window.$ = window.jQuery = _jquery.default;

exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"blocks/datepicker/datepicker.js":[function(require,module,exports) {
...
(function (window, $, undefined) {
  ...
  (function () {
    var VERSION = '2.2.3',
      ...
      prevHtml: '<div class="leftArrow"></div>',
      nextHtml: '<div class="rightArrow"></div>',
      navTitles: {
        days: 'MM <i>yyyy</i>',
        months: 'yyyy',
        years: 'yyyy1 - yyyy2'
    ...
    datepicker.prototype = {
      ...
      selectDate: function selectDate(date) {
        ...
        this.lastSelectedDate = date; // On this step timepicker will set valid values in it's instance
      ...
      accept: function accept() {
        ...
        this.$datepicker.removeClass('active').scss({
          left: '-100000px'
        });
        this.focused = '';
        this.keys = [];
...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"blocks/dropdown/dropdown.js":[function(require,module,exports) {
...
var Dropdown = /*#__PURE__*/function () {
  ...
  _createClass(Dropdown, [{
    ...
    value: function init() {
      ...
      var dropdown = doc.querySelector(".ezdropdown");
      var selection = doc.querySelector(".ezdropdown__selection");
      var menu = doc.querySelector(".ezdropdown__menu");
      var row = doc.querySelectorAll(".ezdropdown__row");
      var clearBtn = doc.querySelector(".clr");
      var isRooms = dropdown.classList.contains("each");
      var sumValue = 0;
      var itemQuantity = {};
      isRooms ? selection.innerHTML = "2 спальни, 2 кровати..." : selection.innerHTML = "Сколько гостей"; // Close dropdown when click around

      window.addEventListener("click", function () {
        if (!dropdown.contains(event.target) || event.target.dataset.action == "accept") {
      ...
      if (isRooms) {
        ...
        row.forEach(function (each) {
          ...
          var id = each.dataset.id; // const actual = each;

          var buttons = each.querySelectorAll(".counterBtn");
          var counter = each.querySelector(".counter");
          var decr = each.querySelector(".decr");
          ...
          counter.innerHTML > 0 ? decr.classList.remove("disable") : decr.classList.add("disable"); // Change counters by incr-decr buttons + write result in selector

          buttons.forEach(function (each) {
            each.addEventListener("click", function (event) {
              var value = event.target; // Principle of operation decr/incr buttons
              ...
              counter.innerHTML = itemQuantity[id]; // Add/remove disable class to decr button

              counter.innerHTML > 0 ? decr.classList.remove("disable") : decr.classList.add("disable"); // Placeholder if all counters = 0

              var sumValue = Object.values(itemQuantity).reduce(function (a, b) {
                return a + b;
              }); // 

              var resultSelection = Object.entries(itemQuantity).filter(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 2),
                    val = _ref2[1];

                return val > 0;
              }).map(function (each) {
                return each.reverse().join(" ");
              }).join(", ").toLowerCase().slice(0, 20).trim().concat("...");
              selection.innerHTML = resultSelection;
              sumValue == 0 ? selection.innerHTML = "Выберите планировку" : selection.innerHTML = resultSelection;
            });
          });
        });
      } else {
        ...
        row.forEach(function (each) {
          // For each item vars block
          var id = each.dataset.id;
          var buttons = each.querySelectorAll(".counterBtn");
          var counter = each.querySelector(".counter");
          var decr = each.querySelector(".decr");
          itemQuantity[id] = 0;
          counter.innerHTML = itemQuantity[id]; // Clear all counters by click on clear button

          doc.addEventListener("click", function () {
            var bottomBtn = event.target;
            ...
            counter.innerHTML = itemQuantity[id];
            var itemQuantityValues = Object.values(itemQuantity);
            sumValue = itemQuantityValues.reduce(function (a, b) {
              return a + b;
            });
            sumValue == 0 ? selection.innerHTML = "Сколько гостей" : sumValue == 1 ? selection.innerHTML = sumValue + " гость" : selection.innerHTML = sumValue + " гостей";
          ...
          buttons.forEach(function (each) {
            each.addEventListener("click", function (event) {
              ...
              counter.innerHTML = itemQuantity[id];
              counter.innerHTML > 0 ? decr.classList.remove("disable") & clearBtn.classList.remove("hide") : decr.classList.add("disable");
              var itemQuantityValues = Object.values(itemQuantity);
              sumValue = itemQuantityValues.reduce(function (a, b) {
                return a + b;
              });
...
},{"jquery":"../../../node_modules/jquery/dist/jquery.js"}],"blocks/likeBtn/likeBtn.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
  ...
  _createClass(LikeButton, [{
    ...
    value: function init() {
      ...
      btn.addEventListener("click", function () {
        ...
        heartIcon = like ? "favorite" : "favorite_border"; // console.log(btn.classList)
...
},{}],"blocks/rateStars/rateStars.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var rateStars = document.querySelectorAll(".rateStars");
rateStars.forEach(function (e) {
  new StarRating(e);
});
},{}],"blocks/blocks.js":[function(require,module,exports) {
"use strict";
...
require("./likeBtn/likeBtn");

require("./rateStars/rateStars");
},{"./datepicker/datepicker":"blocks/datepicker/datepicker.js","./dropdown/dropdown":"blocks/dropdown/dropdown.js","./likeBtn/likeBtn":"blocks/likeBtn/likeBtn.js","./rateStars/rateStars":"blocks/rateStars/rateStars.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"base.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./fonts\\Quicksand-Bold.woff":[["Quicksand-Bold.9d6d9460.woff","fonts/Quicksand-Bold.woff"],"fonts/Quicksand-Bold.woff"],"./fonts\\Quicksand-Bold.svg":[["Quicksand-Bold.e7597636.svg","fonts/Quicksand-Bold.svg"],"fonts/Quicksand-Bold.svg"],"./fonts\\Quicksand-Regular.woff":[["Quicksand-Regular.802b5f30.woff","fonts/Quicksand-Regular.woff"],"fonts/Quicksand-Regular.woff"],"./fonts\\Quicksand-Regular.svg":[["Quicksand-Regular.d6fe3367.svg","fonts/Quicksand-Regular.svg"],"fonts/Quicksand-Regular.svg"],"./fonts\\Montserrat-Bold.woff":[["Montserrat-Bold.73e94c2c.woff","fonts/Montserrat-Bold.woff"],"fonts/Montserrat-Bold.woff"],"./fonts\\Montserrat-Bold.svg":[["Montserrat-Bold.0fff2121.svg","fonts/Montserrat-Bold.svg"],"fonts/Montserrat-Bold.svg"],"./fonts\\Montserrat-Regular.woff":[["Montserrat-Regular.1b35f2ae.woff","fonts/Montserrat-Regular.woff"],"fonts/Montserrat-Regular.woff"],"./fonts\\Montserrat-Regular.svg":[["Montserrat-Regular.6f6bdac5.svg","fonts/Montserrat-Regular.svg"],"fonts/Montserrat-Regular.svg"],"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"blocks/blocks.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"pages/pages.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
require("../node_modules/jquery/dist/import-jquery");

require("./blocks/blocks.js");

require("./base.scss");

require("./blocks/blocks.scss");

require("./pages/pages.scss");
},{"../node_modules/jquery/dist/import-jquery":"../node_modules/jquery/dist/import-jquery.js","./blocks/blocks.js":"blocks/blocks.js","./base.scss":"base.scss","./blocks/blocks.scss":"blocks/blocks.scss","./pages/pages.scss":"pages/pages.scss"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
