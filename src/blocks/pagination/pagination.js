...
Pagination.prototype.createInstance = function createInstance($element) {
  ...
  $element.pagination({
    ...
    prevText: '<button class="material-icons pagination__arrow-prev">arrow_back</button>',
    nextText: '<button class="material-icons pagination__arrow-next">arrow_forward</button>',
